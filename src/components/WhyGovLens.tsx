const STATS = [
  ...
  { stat: "100%", label: "Your data, your control", sub: "Each LGU's data is fully isolated." },
  { stat: "45 days", label: "Free pilot — no commitment", sub: "See the value before you pay anything." },
];

export default function WhyGovLens() {
  return (
    <section className="py-24 px-[5%]" style={{ background: "var(--surf)" }}>
      <div className="max-w-[1100px] mx-auto">
        ...
        >
          ...
          <em className="not-italic" style={{ color: "var(--gl)" }}>office.</em>
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {STATS.map((s) => (
            ...
            >
              ...
              <div className="text-[13px] font-semibold mb-1" style={{ color: "var(--dark)" }}>
                {s.label}
              </div>
